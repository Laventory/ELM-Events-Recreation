...
# How it works
It is practically the same as the original FSPRO-Recreation.  Before asking about "missing sounds"  make sure you import the assets from the base Pizza Tower banks like you would the normal FSPRO.
